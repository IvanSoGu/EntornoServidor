...
function mostrarDatos (){
    ...
    foreach ($tpro as $producto) {
        ...
        $msg .="<td><a href=\"#\" onclick=\"confirmarBorrar('$producto->PRODUCTO_NO','$producto->DESCRIPCION');\" >Borrar</a></td>\n";
        $msg .="<td><a href=\"".$auto."?orden=Modificar&id=$producto->DESCRIPCION\">Modificar</a></td>\n";
        $msg .="<td><a href=\"".$auto."?orden=Detalles&id=$producto->DESCRIPCION\" >Detalles</a></td>\n";
        $msg .="</tr>\n";
